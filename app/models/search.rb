...
")
  ...
  def create_cafe(result)
    ...
    Cafe.create(search_id: self.id, name: @name, image_url: @image_url, address: @address)
  end

  @@cafe_pics_array = ["http://upload.wikimedia.org/wikipedia/commons/4/45/A_small_cup_of_coffee.JPG","http://upload.wikimedia.org/wikipedia/commons/f/f8/Love_Coffee.jpg","http://upload.wikimedia.org/wikipedia/commons/0/0c/Coffee_time_(2410222127).jpg","http://upload.wikimedia.org/wikipedia/commons/9/9d/Morning_cup_of_coffee_black_no_sugar.jpg","http://upload.wikimedia.org/wikipedia/commons/4/4b/Coffee_break_(3457656569).jpg","https://c1.staticflickr.com/3/2257/2182764740_bac869d3f4.jpg","https://c2.staticflickr.com/2/1196/4611048929_a5ca42e054_z.jpg","https://c1.staticflickr.com/3/2636/3992916003_dac7e3d823_b.jpg","http://fc02.deviantart.net/fs70/i/2011/270/1/0/latte_art___unicorn_by_coffee_secrets-d4b4kv0.jpg"]
end
